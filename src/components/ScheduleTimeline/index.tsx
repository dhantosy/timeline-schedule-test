...
export default function ScheduleTimeline({ groups, items }: ScheduleTimelineProps) {
  ...
  return (
    <div className='relative px-10'>
      <input type='text' className='absolute z-10 rounded px-2 py-1 left-14 top-3 max-w-[165px] focus-visible:outline-none' placeholder='Search' />
